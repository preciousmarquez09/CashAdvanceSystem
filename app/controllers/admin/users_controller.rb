class Admin::UsersController < ApplicationController
    ...
    def reset_password
        ...
        if @user.update(password: new_password, password_confirmation: new_password, temporary_password: new_password)
          # Only bypass sign in if you're resetting your own password
    ...
    def user_params
        params.require(:user).permit(:f_name, :m_name, :l_name, :birthday, :civil_status, :email, :gender, :employee_id, :job_title, :hire_date, :employment_status, :salary, :role, :password, :profile_picture, :remove_profile)
    end
